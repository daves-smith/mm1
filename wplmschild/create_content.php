                ...
                <div class="create_course_content content">
                    <div id="create_course" class="active">
                        <article class="live-edit" data-model="article" data-id="1" data-url="/articles">
                            ...
                            <br class="clear" />
                            <hr />
							  <label><?php _e('INSERT VIDEO','vibe'); ?></label>
							 <div id="course_video" class="upload_video_button" data-input-name="course-video" data-uploader-title="Upload a Course Video" data-uploader-button-text="Set as Course Video" data-uploader-allow-multiple="false"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/uploadvideo.jpg" alt="upload video" /></div>
										&nbsp; (Or)
&nbsp;
							 <textarea data-video-src="video url" id="upload_course_video" name="upload_course_video" data-help-tag="5" rows="4"><?php if(isset($_GET['action'])) { echo get_field('upload_course_video',$_GET['action']); } else { echo "Insert Video Url"; }?> </textarea>
						
                            <?php
                                if(isset($linkage) && $linkage){                                        
                            ?>
                            <label><?php _e('COURSE LINKAGE','vibe'); ?></label>
                            <ul id="course-linkage" data-help-tag="6">
                                <li>
                            ...
                            ?>
                            <div class="clear"></div>
                            <h3 class="course_status" data-help-tag="7"><?php _e('Change Course Status','vibe'); ?><span>
                                <div class="switch">
                    ...
                    <?php
                        if(!$live_flag){
                            ?>
                                <h3 class="heading"><?php _e('Modify Course'); ?> <span><a href="<?php echo get_permalink($_GET['action']); ?>"><?php _e('Back to course','vibe'); ?></a></span></h3>
                                <?php
                                    if(isset($_GET['action'])){
