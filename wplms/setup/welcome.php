	...
	public function about_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						<h4><?php _e( '38 Bugs fixes and Updates', 'vibe' ); ?></h4>
					...
					<div class="col-2">
						<h4><?php _e( 'Security Update', 'vibe' ); ?></h4>
						<p><?php _e( 'Two major security issues has been fixed in this update. We resolved a security issue related to forms and another related to import.', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/13907-update-log-what-features-we-added-in-version-1-9-1" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Course Codes', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/course_codes.gif'; ?>" /></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/55662-feature-course-codes" class="button" target="_blank"><?php _e('Tutorial','vibe'); ?></a>
					</div>
					<div>
						<h4><?php _e( 'Modify/Delete Course', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/delete_course.gif'; ?>" /></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/55669-tip-modify-delete-course" class="button" target="_blank"><?php _e('Tutorial','vibe'); ?></a>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Unit start date/time', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/unit_start_datetime.gif'; ?>" /></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/54659-tip-enabling-unit-start-date-and-time-in-course-drip-feed" class="button" target="_blank"><?php _e('Tutorial','vibe'); ?></a>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Instructor Filter', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/instructor_filter.gif'; ?>" /></p>
					</div>
					<div>
						<h4><?php _e( 'Assignment Re-design', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/assignment-redesign.png'; ?>" /></p>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Single Login session', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/logged-in.png'; ?>" /></p>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Set default Course Order', 'vibe' ); ?></h4>
						<p><?php _e( 'You can now set a default order for Course directory. This option is available in LMS -> settings -> General section, chose sort order from Recent,popular,rated and alphabetical', 'vibe' ); ?></p>
					</div>
					<div>
						<h4><?php _e( 'Disable Free course auto assignment', 'vibe' ); ?></h4>
						<p><?php _e( 'Now you can disable auto subscription of free courses. For a free course students would be required to click on take this course to subscribe to the course.', 'vibe' ); ?></p>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Updated Carousel widget', 'vibe' ); ?></h4>						
						<p><?php _e( 'Vibe Carousels Widget has been updated. You can now use it to show various types of carousels. Checkout the dark carousel theme added for footer.', 'vibe' ); ?></p>
					</div>
				</div>
			</div>
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						<h4><?php _e( 'WPLMS Child theme updated', 'vibe' ); ?></h4>
						<p><?php _e( 'Few issues related to WPLMS Child theme with sticky header has been resolved in the latest theme package. The main issues resolved are related to directories being overlapped by header and header appearance on mobile/ipad.', 'vibe' ); ?></p>
					</div>
					<div>
						<h4><?php _e( 'Package Uploader restructured', 'vibe' ); ?></h4>
						<p><?php _e( 'Package uploader has been re-coded, it now supports Instructor content privacy and adds option for iframe height and iframe source.', 'vibe' ); ?></p>
					</div>
					<div class="last-feature">
